...
namespace PersonalAssistantBot
{
    public class AlineReceiver : IMessageReceiver
    {
        ...
        private Document AlineCarrossel()
        {
            ...
            cards.Add(new CarrosselCard { CardMediaHeader = new MediaLink { Uri = new Uri("https://image.freepik.com/icones-gratis/curva-de-ponto-de-seta-para-a-esquerda_318-10099.jpg"), Text = "Voltar para o Bot normal.", Title = "Voltar", Type = new MediaType("image", "jpeg") }, CardContent = "Voltar para o Bot normal.", options = new List<CarrosselOptions>() });
